...
use crate::error::{
    IntrospectGrimoireBindingStatusError, IntrospectGrimoireBindingStatusErrorWithContext,
};
...
impl GrimoireBindingStatus {
    ...
    pub fn introspect() -> stdrt::Result<Self, IntrospectGrimoireBindingStatusErrorWithContext> {
        debug!("Introspecting grimoire binding status...");

        let status = introspect_inner()
            .map_err(|e| IntrospectGrimoireBindingStatusErrorWithContext { source: e })?;
...
fn introspect_inner() -> stdrt::Result<GrimoireBindingStatus, IntrospectGrimoireBindingStatusError>
{
