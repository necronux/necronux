...
impl TryFrom<ParsedToolProvisioningCommands> for NormalizedToolProvisioningCommands {
    ...
    fn try_from(s: ParsedToolProvisioningCommands) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            ...
            verify_installation_command_prefix_args: s.verify_installation_command_prefix_args,
            verify_installation_command: normalizers::ensure_req_field_is_not_missing(
