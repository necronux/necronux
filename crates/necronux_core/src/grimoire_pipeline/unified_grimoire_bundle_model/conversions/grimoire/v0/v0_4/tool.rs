...
impl From<ValidatedToolProvisioningCommands> for UnifiedToolProvisioningCommands {
    fn from(s: ValidatedToolProvisioningCommands) -> Self {
        Self {
            ...
            verify_installation_command_prefix_args: SchemaField::Present(
                s.verify_installation_command_prefix_args,
            ),
            verify_installation_command: SchemaField::Present(s.verify_installation_command),
